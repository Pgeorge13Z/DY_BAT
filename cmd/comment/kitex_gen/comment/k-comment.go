...
func (p *DouyinCommentListResponse) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "comment_list", thrift.STRUCT, 2)
	offset += p.CommentList.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}
...
func (p *DouyinCommentListResponse) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("comment_list", thrift.STRUCT, 2)
	l += p.CommentList.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}
