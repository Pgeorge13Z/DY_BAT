...
type DouyinFeedResponse struct {
	...
	VedioList  []*Video `thrift:"vedio_list,3,required" frugal:"3,required,list<Video>" json:"vedio_list"`
...
func (p *DouyinFeedResponse) SetVedioList(val []*Video) {
	p.VedioList = val
}
...
func (p *FeedServiceGetUserFeedArgs) SetReq(val *DouyinFeedRequest) {
	p.Req = val
}
...
func (p *FeedServiceGetUserFeedArgs) Field1DeepEqual(src *DouyinFeedRequest) bool {
...
func (p *FeedServiceGetUserFeedResult) Field0DeepEqual(src *DouyinFeedResponse) bool {
